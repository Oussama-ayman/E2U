...
class Vendor {
  ...
  factory Vendor.fromJson(
    ...
    Vendor vendor = Vendor(
      ...
      latitude: json["latitude"] == null ? "0.00" : json["latitude"].toString(),
      longitude: json["longitude"] == null ? "0.00" : json["longitude"].toString(),
      comission:
          json["comission"] == null
              ? 0
      ...
      featureImage:
          json["feature_image"] == null ? "" : json["feature_image"],
      menus:
          json["menus"] == null
              ? []
      ...
      //
      canRate: json["can_rate"] == null ? false : json["can_rate"],
      hasSubcategories:
