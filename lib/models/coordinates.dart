class Coordinates {
  ...
  Coordinates.fromMap(Map map)
      : this.latitude = double.tryParse((map.containsKey("latitude") ? map["latitude"] : map["lat"]).toString()) ?? 0.0,
        this.longitude = double.tryParse((map.containsKey("longitude") ? map["longitude"] : map["lng"]).toString()) ?? 0.0;
