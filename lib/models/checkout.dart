  ...
  factory CheckOut.fromJson(Map<String, dynamic> json) {
    return CheckOut(
      subTotal: json["sub_total"] == null
          ? 0.00
          : double.tryParse(json["sub_total"].toString()) ?? 0.0,
      discount: json["discount"] == null
          ? 0.00
          : double.tryParse(json["discount"].toString()) ?? 0.0,
      deliveryDiscount: json["delivery_discount"] == null
          ? 0.00
          : double.tryParse(json["delivery_discount"].toString()) ?? 0.0,
      deliveryFee: json["delivery_fee"] == null
          ? 0.00
          : double.tryParse(json["delivery_fee"].toString()) ?? 0.0,
      tax: json["tax"] == null ? 0.00 : double.tryParse(json["tax"].toString()) ?? 0.0,
      tax_rate: double.tryParse(json["tax_rate"].toString()),
      total:
          json["total"] == null ? 0.00 : double.tryParse(json["total"].toString()) ?? 0.0,
      totalWithTip: json["total_with_tip"] == null
          ? 0.00
          : double.tryParse(json["total_with_tip"].toString()) ?? 0.0,
