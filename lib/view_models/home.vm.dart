...
// Removed Firebase Dynamic Links import
...
class HomeViewModel extends MyBaseViewModel {
  ...
  void initialise() async {
    ...
    // Initialize video call service if user is authenticated
  ...
  Future<void> _initializeVideoCallService() async {
    try {
      if (AuthServices.authenticated()) {
        ...
        debugPrint(
          'HomeViewModel: Video call service initialized successfully',
        );
      } else {
        debugPrint(
          'HomeViewModel: User not authenticated, skipping video call service initialization',
        );
      }
    } catch (e) {
      debugPrint('HomeViewModel: Error initializing video call service: $e');
    }
  }

  //
  handleAppLink() async {
    print("Firebase Dynamic Links disabled - app links not supported");
    // Firebase Dynamic Links functionality removed
  }
