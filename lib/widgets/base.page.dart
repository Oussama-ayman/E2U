...
class _BasePageState extends State<BasePage> {
  ...
  void initState() {
    super.initState();
    // Enhanced screen identification showing the actual screen class
    final handlerName = "BasePage";
    final titleName = widget.title?.toString() ?? 'No Title';
    print('Screen: $titleName (Rendered by: $handlerName)');
  }
