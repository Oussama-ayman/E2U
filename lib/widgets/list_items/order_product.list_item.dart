        ...
        child: HStack([
          RoundedContainer(
            child: CustomImage(
              ...
              width: 100, // Increased from 50 to 100 (2x)
              height: 100, // Increased from 50 to 100 (2x)
            ),
          ),
        ...
        child: VStack([
          HStack([
            ...
            RoundedContainer(
              child: CustomImage(
                imageUrl: orderProduct.product!.photo,
                width: 120, // Increased from 60 to 120 (2x)
                height: 120, // Increased from 60 to 120 (2x)
              ),
            ),
