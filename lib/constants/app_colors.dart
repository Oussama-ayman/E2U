...
class AppColor {
  ...
  static Future<bool> saveColorsToLocalStorage(String colorsMap) async {
    if (LocalStorageService.prefs == null) {
      return false; // Return false if prefs is not initialized
    }
  ...
  static Future<void> getColorsFromLocalStorage() async {
    if (LocalStorageService.prefs == null) {
      appColorsObject = null; // Set to null if prefs is not initialized
      return;
    }
  ...
  static String colorEnv(String colorRef) {
    ...
    String? selectedColor =
        appColorsObject != null ? appColorsObject[colorRef] : "#533b85";
    if (selectedColor == null) {
      selectedColor = "#533b85";
    }
