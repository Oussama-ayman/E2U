  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (LocationService.currenctAddress == null) {
        ...
        LocationService.prepareLocationListenerSafely(true)
            .then((success) {
              if (!success) {
                print("Failed to prepare location listener in home page");
              }
            })
            .catchError((error) {
              print("Error preparing location listener in home page: $error");
            });
      }
      vm.initialise();
    });
